...
describe('config/index.js', () => {
  ...
  describe('integration', () => {
    it('STORAGE_KEYS values should be generated using getStorageKey', async () => {
      ...
      expect(STORAGE_KEYS.BRICKRUSH_HIGH_SCORE).toBe(getStorageKey('brickrushHighScore'));
      expect(STORAGE_KEYS.GAME_1024_BEST_SCORE).toBe(getStorageKey('game1024BestScore'));
      expect(STORAGE_KEYS.SNAKE_HIGH_SCORE).toBe(getStorageKey('snakeHighScore'));
    });
