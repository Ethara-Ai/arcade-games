  ...
  return (
    <div className="game-selector fixed inset-0 bg-[#0a0a0a] flex flex-col items-center justify-start md:justify-center p-3 sm:p-4 z-50 overflow-y-auto">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-amber-500/15 rounded-full blur-[60px] sm:blur-[80px] md:blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 right-1/3 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-green-500/15 rounded-full blur-[60px] sm:blur-[80px] md:blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-1/2 left-1/3 w-32 sm:w-48 md:w-64 h-32 sm:h-48 md:h-64 bg-pink-500/10 rounded-full blur-[40px] sm:blur-[60px] md:blur-[80px] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      </div>
          ...
          >
            ...
            <div className="relative z-10 flex sm:block items-center gap-4 sm:gap-0">
              ...
              <div className="flex-1 sm:flex-none">
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1 sm:mb-2" style={{ fontFamily: '"Raleway", sans-serif' }}>
                  Brickrush
                </h2>
                ...
                <div className="flex gap-1.5 sm:gap-2 mt-2 sm:mt-4">
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-cyan-400 text-[10px] sm:text-xs rounded-full border-cyan-500/20">Arcade</span>
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-pink-400 text-[10px] sm:text-xs rounded-full border-pink-500/20">Action</span>
                </div>
              </div>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative z-10 flex sm:block items-center gap-4 sm:gap-0">
              ...
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-amber-400 to-orange-500 rounded-lg sm:rounded-xl flex items-center justify-center sm:mb-4 shadow-lg shadow-amber-500/40 flex-shrink-0">
                <span className="text-white font-black text-sm sm:text-base md:text-xl" style={{ fontFamily: '"Raleway", sans-serif' }}>
                  1024
                </span>
              </div>
              ...
              <div className="flex-1 sm:flex-none">
                ...
                <p className="text-gray-400 text-xs sm:text-sm hidden sm:block">
                  Slide and merge tiles to reach 1024
                </p>

                {/* Tags */}
                <div className="flex gap-1.5 sm:gap-2 mt-2 sm:mt-4">
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-amber-400 text-[10px] sm:text-xs rounded-full border-amber-500/20">Puzzle</span>
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-cyan-400 text-[10px] sm:text-xs rounded-full border-cyan-500/20">Strategy</span>
                </div>
              </div>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative z-10 flex sm:block items-center gap-4 sm:gap-0">
              ...
              <div className="flex-1 sm:flex-none">
                ...
                {/* Tags */}
                <div className="flex gap-1.5 sm:gap-2 mt-2 sm:mt-4">
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-green-400 text-[10px] sm:text-xs rounded-full border-green-500/20">Classic</span>
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 glass-stat text-pink-400 text-[10px] sm:text-xs rounded-full border-pink-500/20">Arcade</span>
                </div>
              </div>
            </div>
          </button>
