      ...
      <div className="menu-content">
        ...
        <div className="glass-panel rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 max-w-sm mx-3 sm:mx-4">
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            ...
            <button
              onClick={onRestart}
              className="w-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-semibold cursor-pointer rounded-lg sm:rounded-xl shadow-lg shadow-cyan-400/30 transition-all duration-300 hover:brightness-110 hover:shadow-xl hover:shadow-cyan-400/50 active:brightness-90 focus:outline-none py-3 sm:py-4 text-sm sm:text-base"
            >
              Restart
            </button>
            <button
