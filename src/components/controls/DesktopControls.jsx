...
const DesktopControls = ({
  ...
  return (
    <div className="desktop-controls">
      ...
      <button
        onClick={onBack}
        className={`desktop-back-btn bg-gradient-to-br from-cyan-400 to-blue-500 border-none rounded-full text-white text-lg cursor-pointer shadow-lg shadow-cyan-400/40 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-cyan-400/60 active:scale-95 focus:outline-none ${showControls ? 'show' : ''}`}
