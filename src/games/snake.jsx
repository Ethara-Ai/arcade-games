...
const SnakeGame = ({ onBack }) => {
  ...
  return (
    <div className="snake-game-container flex flex-col items-center justify-center h-screen overflow-hidden p-4 bg-[#0a0a0a]">
      ...
      <div className="relative z-10 w-full max-w-md px-2 sm:px-0">
        ...
        <div
          className="relative glass-green rounded-2xl p-3"
